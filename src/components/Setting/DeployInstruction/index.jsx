...
export default class DeployInstruction extends Component {
    ...
    handleVideoCancel() {
        const video = document.getElementById('deploy-video');
        video.currentTime = 0;
        video.pause();

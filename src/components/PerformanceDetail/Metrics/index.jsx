                        ...
                        <div className={styles['props']}>
                            ...
                            <dl>
                                ...
                                props.specificUrls && props.specificUrls.length > 0 ?
                                 <dd>
                                    <Select dropdownClassName={styles['url_selectDropdown']} labelInValue defaultValue={{key:props.requestPath == '' ? props.specificUrls[0].url : props.requestPath}} style={{ width: 120 }} onChange={this.handleSelectChange.bind(this)}>
